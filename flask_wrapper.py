...
def f1(): return api_repr(system.plugins)

@app.route("/plugins/loaded/", methods=['GET'])
def f2(): return api_repr(system.loaded_plugins)

@app.route("/plugins/loaded/input/", methods=['GET'])
def f3(): return api_repr(system.loaded_input_plugins)

@app.route("/plugins/loaded/storage/", methods=['GET'])
def f4(): return api_repr(system.loaded_storage_plugins)

@app.route("/plugins/loaded/query/", methods=['GET'])
def f5(): return api_repr(system.loaded_query_plugins)
...
def f8(): return api_repr(system.connections)
...
def f11(): return api_repr(system.interface_id)
